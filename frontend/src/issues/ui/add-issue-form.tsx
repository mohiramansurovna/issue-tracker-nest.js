...
import {useAddIssueMutation} from '../hook/useIssueMutations';
...
export function AddIssueForm() {
    ...
    return (
        <Card className='w-full sm:max-w-md rounded-none bg-transparent place-self-center border-transparent'>
            <CardHeader>
                <CardTitle className='text-2xl text-center'>Add issue</CardTitle>
            </CardHeader>
            <CardContent>
                <form
                    id='add-issue-form'
                                ...
                                return (
                                    <Field data-invalid={isInvalid}>
                                        ...
                                        <Input
                                            ...
                                            placeholder='Found a bug in the add issue form'
                                        />
                                        {isInvalid && (
                                    ...
                                    <FieldSet>
                                        <FieldLegend className='text-sm'>Priority</FieldLegend>
                                            <RadioGroup
                                                ...
                                                value={field.state.value}
                                                onValueChange={value =>
                                                    field.handleChange(value as IssuePriority)
                                                }
                                                className='flex gap-1'>
